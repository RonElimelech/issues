...
- Explain the relation between iptables chains and netfilter events 
- Why are there different chains in different tables?
...
- Create a rule that allows all incoming HTTP but 1 IP address (HTTP from this IP is not allowed)
