...
> In this part of the training, you'll discover a highly valuable tool: `xargs`. Pay close attention to it, as it will be incredibly useful. 
> We recommend playing around with it a bit, especially understanding its syntax and relatively small selection of flags.
...
- Explain the following command: `ls > /dev/null`. Why is there no output?
