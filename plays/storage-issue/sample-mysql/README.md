/home/automation/plays/storage-issue/sample-mysql

role called sample-mysql, The role supposed to run on hosts in the database host group and achives the following requirements:
...
MySQL root user password should be set with the value of devops.
